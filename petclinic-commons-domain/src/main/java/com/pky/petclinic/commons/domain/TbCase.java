...
public class TbCase extends AbstractBaseDomain {

    private static final long serialVersionUID = 8193567401470951360L;
    /**
     * 卡号
     */
    @Column(name = "card_id")
    ...
    @NotNull(message = "处方号不可为空")
    private String prescriptionId;

    /**
     * 医生名
     */
    @NotNull(message = "医生名不可为空")
